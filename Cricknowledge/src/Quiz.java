...
public class Quiz { //THE QUIZ CLASS

	//DECLARATION AND INSTALLATION OF VARIABLES USED IN THE PROGRAM
	...
	static JFrame frame = new JFrame("CricKnowledge");
	...
	//THE MAIN METHOD
	public static void Quiz(int usr) throws IOException {
		...
		jMenuHelpAbout.addActionListener(new ActionListener()  {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame, "CricKnowledge\nDesigned By JAVA BOYS\n");
		...
		contentPane.add(aRadioButton,  new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
				,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(20, 24, 0, 0), 0, 0));
		contentPane.add(bRadioButton,  new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0
				,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(20, 61, 0, 0), 0, 0));
		contentPane.add(cRadioButton,  new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0
				,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(21, 71, 0, 19), 0, 0));
		contentPane.add(dRadioButton,  new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0
				,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(20, 65, 0, 0),0, 0));


		//ALLOW USER TO SUPPLY SERVER'S NAME AND CAPTURE INPUT
		System.out.println("Welcome to CricKnowledge\n Enjoyyour Game !!!\n");

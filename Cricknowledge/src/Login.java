...
public class Login{
    ...
    public void loginView() {
        ...
        //-------------------------LOGO--------------------------
        JLabel attendance = new JLabel("Cricknowledge");
        attendance.setForeground(Color.decode("#37474F"));
        attendance.setBounds(100, 275, 400, 50);
        attendance.setFont(new Font("Verdana", Font.BOLD, 40));
        frame.add(attendance);
        JLabel management = new JLabel("Cricket Quiz game");
        management.setForeground(Color.decode("#37474F"));
        management.setBounds(280, 310, 400, 50);
        management.setFont(new Font("Verdana", Font.BOLD, 10));
